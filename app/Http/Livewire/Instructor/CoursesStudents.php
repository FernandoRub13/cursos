...
class CoursesStudents extends Component
{
    ...
    {
        $this->authorize('dictated', $course);  //Verifica si el usuario tiene permiso para acceder a la ruta
        $this->course = $course;
    }

    public function updatingSearch()
    {
        $this->resetPage(); //Resetea la paginación cuando se realiza una búsqueda de un usuario
    }
